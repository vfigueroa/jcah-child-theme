...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<!-- add get_theme_root() by JCAH -->
		<?php require_once( get_theme_root() . '/wp-bootstrap/library/typeahead.php'); ?>
						...
						<div class="container-fluid nav-container">
							<nav role="navigation">
								...
								<div class="nav-collapse">
									<?php $assignmentList = createMainNavAssignmentList(); //JCAH Customization ?>
